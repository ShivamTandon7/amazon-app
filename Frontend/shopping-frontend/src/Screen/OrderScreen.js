...
export default function OrderScreen(props) {
    ...
    const {error: errorPay, success: succesPay, loading: loadingPay} = orderPay;
    ...
    useEffect(()=>{
        ...
        if(!order || succesPay || successDeliver || (order && order._id !== orderId)){
    ...
    },[dispatch, order, orderId, succesPay, successDeliver ])
